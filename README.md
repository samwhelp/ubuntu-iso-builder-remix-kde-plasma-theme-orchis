...
> [ubuntu-iso-builder-remix-kde-plasma-theme-orchis](https://samwhelp.github.io/ubuntu-iso-builder-remix-kde-plasma-theme-orchis/)
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-kde-plasma-theme-orchis/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-kde-plasma-theme-orchis/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-kde-plasma-theme-orchis/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-kde-plasma-theme-orchis](https://github.com/samwhelp/ubuntu-iso-builder-remix-kde-plasma-theme-orchis)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-kde-plasma-theme-orchis.git
```


> change dir to `ubuntu-iso-builder-remix-kde-plasma-theme-orchis`

``` sh
cd ubuntu-iso-builder-remix-kde-plasma-theme-orchis
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-kde-plasma-theme-orchis/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-kde-plasma-theme-orchis/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-kde-plasma-theme-orchis/iso-profile/dist`
