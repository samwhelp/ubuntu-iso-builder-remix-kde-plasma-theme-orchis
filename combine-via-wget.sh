...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-remix-kde-plasma-theme-orchis"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-remix-kde-plasma-theme-orchis/iso-profile
"
echo
